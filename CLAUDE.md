...
If you are an LLM (any model, any tool — Claude Code, Cursor, ChatGPT with repo access, etc.) opening this repository for the first time, read this file fully before doing anything else. It is the map; it is not the plan or the status — those live in the files this points to.
