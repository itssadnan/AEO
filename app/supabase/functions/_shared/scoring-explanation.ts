// Deno-side twin of src/modules/scoring-explanation/{schemas,prompt,parse-explanation-response}.ts
...
export const explanationResultSchema = z.object({
  ...
  recommended_actions: z.array(recommendedActionSchema).min(1).max(10),
});
